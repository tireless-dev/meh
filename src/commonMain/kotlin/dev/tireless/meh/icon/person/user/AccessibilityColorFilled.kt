...
val AccessibilityColorFilled: ImageVector
    get() {
        val current = _accessibilityColorFilled
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.AccessibilityColorFilled",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M16 10 a8.6 8.6 0 0 0 -7.96 6 A8.6 8.6 0 0 0 16 22 a8.6 8.6 0 0 0 7.96 -6 A8.6 8.6 0 0 0 16 10 m0 10 a4 4 0 1 1 4 -4 4 4 0 0 1 -4 4
            path(
            ...
            // M16 2 a14 14 0 1 0 14 14 A14 14 0 0 0 16 2 m0 22 a10.65 10.65 0 0 1 -9.97 -7.76 L5.97 16 l.06 -.24 A10.65 10.65 0 0 1 16 8 a10.65 10.65 0 0 1 9.97 7.76 L26.03 16 l-.06 .24 A10.65 10.65 0 0 1 16 24
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 16 2
        ...
        }.build().also { _accessibilityColorFilled = it }
    }

@Suppress("ObjectPropertyName")
private var _accessibilityColorFilled: ImageVector? = null
