...
val FaceWink: ImageVector
    get() {
        val current = _faceWink
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.FaceWink",
            ...
            // M20.5 11 a2.5 2.5 0 1 0 2.5 2.5 2.5 2.5 0 0 0 -2.5 -2.5
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 20.5 11
                moveTo(x = 20.5f, y = 11.0f)
            ...
            // <rect width="6" height="2" x="8.0" y="13.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 8 13
