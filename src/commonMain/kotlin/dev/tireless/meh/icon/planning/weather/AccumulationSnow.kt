...
val AccumulationSnow: ImageVector
    get() {
        val current = _accumulationSnow
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.AccumulationSnow",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <rect width="2" height="2" x="12.0" y="2.0" fill="#000" />
            path(
            ...
            // <rect width="2" height="2" x="14.0" y="4.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 14 4
            ...
            // <rect width="2" height="2" x="14.0" y="18.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 14 18
            ...
            // <rect width="2" height="2" x="14.0" y="22.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 14 22
            ...
            // <rect width="2" height="2" x="20.0" y="12.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 20 12
            ...
            // <rect width="2" height="2" x="22.0" y="14.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 22 14
            ...
            // <rect width="2" height="2" x="22.0" y="10.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 22 10
            ...
            // M28 4 a2 2 0 0 0 -2 2 v20 H6 v-4 h4 v-2 H6 v-4 h4 v-2 H6 v-4 h4 V8 H6 V6 a2 2 0 0 0 -2 -2 H2 v2 h2 v20 a2 2 0 0 0 2 2 h20 a2 2 0 0 0 2 -2 V6 h2 V4Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 28 4
        ...
        }.build().also { _accumulationSnow = it }
    }
