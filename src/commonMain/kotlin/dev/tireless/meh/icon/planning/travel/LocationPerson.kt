...
val LocationPerson: ImageVector
    get() {
        val current = _locationPerson
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.LocationPerson",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M20 19 h-2 v-2 h-4 v2 h-2 v-2 a2 2 0 0 1 2 -2 h4 a2 2 0 0 1 2 2Z m-4 -5 a3 3 0 1 1 3 -3 3 3 0 0 1 -3 3 m0 -4 a1 1 0 1 0 1 1 1 1 0 0 0 -1 -1
            path(
