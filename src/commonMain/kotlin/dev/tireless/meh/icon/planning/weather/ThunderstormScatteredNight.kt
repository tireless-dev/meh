...
val ThunderstormScatteredNight: ImageVector
    get() {
        val current = _thunderstormScatteredNight
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.ThunderstormScatteredNight",
            ...
            // M29.84 13.03 a1.5 1.5 0 0 0 -1.23 -.86 5.4 5.4 0 0 1 -3.4 -1.72 6.5 6.5 0 0 1 -1.3 -6.39 1.6 1.6 0 0 0 -.3 -1.55 1.5 1.5 0 0 0 -1.35 -.49 h-.02 a7.85 7.85 0 0 0 -6.1 6.49 A7 7 0 0 0 13.5 8 a7.55 7.55 0 0 0 -7.15 5.24 A6 6 0 0 0 8 25 v-2 a4 4 0 0 1 -.67 -7.93 l.66 -.11 .15 -.66 a5.5 5.5 0 0 1 10.72 0 l.15 .66 .66 .11 A4 4 0 0 1 19 23 v2 a5.95 5.95 0 0 0 5.88 -7.15 7.5 7.5 0 0 0 4.87 -3.3 1.5 1.5 0 0 0 .1 -1.52 m-5.69 2.92 a6 6 0 0 0 -3.5 -2.7 7.5 7.5 0 0 0 -2.62 -3.7 6 6 0 0 1 3.77 -5.33 8.5 8.5 0 0 0 1.94 7.6 7.4 7.4 0 0 0 3.9 2.22 5.4 5.4 0 0 1 -3.49 1.91
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 29.84 13.03
                ...
                // m -5.69 2.92
                moveToRelative(dx = -5.69f, dy = 2.92f)
                // a 6 6 0 0 0 -3.5 -2.7
                arcToRelative(
                    a = 6.0f,
                    b = 6.0f,
        ...
        }.build().also { _thunderstormScatteredNight = it }
    }
