...
val TemperatureFahrenheit: ImageVector
    get() {
        val current = _temperatureFahrenheit
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.TemperatureFahrenheit",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <polygon points="30.0 6.0 30.0 4.0 22.0 4.0 22.0 18.0 24.0 18.0 24.0 12.0 29.0 12.0 29.0 10.0 24.0 10.0 24.0 6.0 30.0 6.0" fill="#000" />
            path(
        ...
        }.build().also { _temperatureFahrenheit = it }
    }
