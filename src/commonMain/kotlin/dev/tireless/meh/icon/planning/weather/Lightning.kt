...
val Lightning: ImageVector
  get() {
    ...
    return ImageVector
      .Builder(
        name = "MehTheme.Lightning",
        defaultWidth = 32.0.dp,
        defaultHeight = 32.0.dp,
        viewportWidth = 32.0f,
        viewportHeight = 32.0f,
      ).apply {
        // M11.61 29.92 a1 1 0 0 1 -.6 -1.07 L12.83 17 H8 a1 1 0 0 1 -1 -1.23 l3 -13 A1 1 0 0 1 11 2 h10 a1 1 0 0 1 .78 .37 1 1 0 0 1 .2 .85 L20.25 11 H25 a1 1 0 0 1 .9 .56 1 1 0 0 1 -.11 1 l-13 17 A1 1 0 0 1 12 30 a1 1 0 0 1 -.39 -.08 M17.75 13 l2 -9 H11.8 L9.26 15 h5.91 l-1.59 10.28 L23 13Z
        path(
          ...
          // M 17.75 13
          moveTo(x = 17.75f, y = 13.0f)
          // l 2 -9
          lineToRelative(dx = 2.0f, dy = -9.0f)
          // H 11.8
          horizontalLineTo(x = 11.8f)
          // L 9.26 15
          lineTo(x = 9.26f, y = 15.0f)
          // h 5.91
          horizontalLineToRelative(dx = 5.91f)
          // l -1.59 10.28
          lineToRelative(dx = -1.59f, dy = 10.28f)
          // L 23 13z
