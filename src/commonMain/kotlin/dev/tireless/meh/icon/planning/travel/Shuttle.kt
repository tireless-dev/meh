...
val Shuttle: ImageVector
    get() {
        val current = _shuttle
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.Shuttle",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // m29.81 16 -7 -9.56 A1 1 0 0 0 22 6 H3 a1 1 0 0 0 -1 1 v17 a1 1 0 0 0 1 1 h2.14 a4 4 0 0 0 7.72 0 h6.28 a4 4 0 0 0 7.72 0 H29 a1 1 0 0 0 1 -1 v-7.44 A1 1 0 0 0 29.81 16 M20 8 h1.49 l5.13 7 H20Z M4 8 h14 v7 H4Z m5 18 a2 2 0 1 1 2 -2 2 2 0 0 1 -2 2 m14 0 a2 2 0 1 1 2 -2 2 2 0 0 1 -2 2 m5 -3 h-1.14 a4 4 0 0 0 -7.72 0 h-6.28 a4 4 0 0 0 -7.72 0 H4 v-6 h24Z
            path(
