...
val SailboatOffshore: ImageVector
    get() {
        val current = _sailboatOffshore
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.SailboatOffshore",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M6.97 25 h2.06 l-.75 -3 h15.44 l-.75 3 h2.06 l.94 -3.76 A1 1 0 0 0 25 20 h-5 v-3 h5 a1 1 0 0 0 .9 -1.42 l-6 -13 a1 1 0 0 0 -1.7 -.19 l-10 13 A1 1 0 0 0 9 17 h9 v3 H7 a1 1 0 0 0 -.97 1.24Z M20 7.55 23.44 15 H20Z M11.03 15 18 5.94 V15Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 6.97 25
                moveTo(x = 6.97f, y = 25.0f)
                // h 2.06
        ...
        }.build().also { _sailboatOffshore = it }
    }
