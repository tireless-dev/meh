...
val PassengerDrinks: ImageVector
    get() {
        val current = _passengerDrinks
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.PassengerDrinks",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M30 4 V2 h-8 v2 a4 4 0 0 0 3 3.86 V11 h-2 v2 h6 v-2 h-2 V7.86 A4 4 0 0 0 30 4 M10.5 9 A3.5 3.5 0 1 1 14 5.5 3.5 3.5 0 0 1 10.5 9 m0 -5 A1.5 1.5 0 1 0 12 5.5 1.5 1.5 0 0 0 10.5 4 m11.97 27.31 L19.34 24 h-7.1 a4 4 0 0 1 -3.87 -2.97 L6.74 14.9 a3.9 3.9 0 0 1 7.53 -2 L15.1 16 H21 v2 h-7.44 l-1.22 -4.6 a1.9 1.9 0 0 0 -3.67 .99 l1.63 6.12 A2 2 0 0 0 12.24 22 h8.42 l3.65 8.53Z
            path(
        ...
        }.build().also { _passengerDrinks = it }
    }
