...
val ConnectionReceive: ImageVector
    get() {
        val current = _connectionReceive
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.ConnectionReceive",
            ...
            // <polygon points="30.0 14.0 21.83 14.0 24.41 16.59 23.0 18.0 18.0 13.0 23.0 8.0 24.41 9.41 21.83 12.0 30.0 12.0 30.0 14.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 30 14
                ...
                // L 21.83 14
                lineTo(x = 21.83f, y = 14.0f)
                // L 24.41 16.59
                lineTo(x = 24.41f, y = 16.59f)
                // L 23 18
                ...
                // L 24.41 9.41
                lineTo(x = 24.41f, y = 9.41f)
                // L 21.83 12
                lineTo(x = 21.83f, y = 12.0f)
                // L 30 12
        ...
        }.build().also { _connectionReceive = it }
    }
