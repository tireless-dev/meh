...
val WebServicesContainer: ImageVector
    get() {
        val current = _webServicesContainer
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.WebServicesContainer",
        ...
        }.build().also { _webServicesContainer = it }
    }

@Suppress("ObjectPropertyName")
private var _webServicesContainer: ImageVector? = null
