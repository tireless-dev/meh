...
val BuildingInsights2: ImageVector
  get() {
    val current = _buildingInsights2
    if (current != null) return current

    return ImageVector
      .Builder(
        name = "MehTheme.BuildingInsights2",
        ...
        // M5.5 12 a3.5 3.5 0 0 1 0 -7 h.63 A4 4 0 0 1 10 2 h2 v2 h-2 a2 2 0 0 0 -2 2 v1 H5.5 a1.5 1.5 0 0 0 0 3 H12 v2Z
        path(
          fill = SolidColor(Color(0xFF000000)),
        ) {
          // M 5.5 12
          ...
          // h 0.63
          horizontalLineToRelative(dx = 0.63f)
          // A 4 4 0 0 1 10 2
          arcTo(
