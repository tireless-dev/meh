...
val Airplay: ImageVector
    get() {
        val current = _airplay
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.Airplay",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M23 30 H9 a1 1 0 0 1 -.82 -1.58 l7 -10 a1 1 0 0 1 1.64 0 l7 10 A1 1 0 0 1 23 30 m-12.08 -2 h10.16 L16 20.74Z
            path(
                ...
                // m -12.08 -2
                moveToRelative(dx = -12.08f, dy = -2.0f)
                // h 10.16
                horizontalLineToRelative(dx = 10.16f)
                // L 16 20.74z
                lineTo(x = 16.0f, y = 20.74f)
                close()
            }
