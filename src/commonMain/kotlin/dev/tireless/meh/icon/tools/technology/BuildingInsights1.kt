...
val BuildingInsights1: ImageVector
    get() {
        val current = _buildingInsights1
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.BuildingInsights1",
            ...
            // M9 12 H7 a5 5 0 0 1 5 -5 v2 a3 3 0 0 0 -3 3 m-5 0 H2 A10 10 0 0 1 12 2 v2 a8 8 0 0 0 -8 8
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 9 12
        ...
        }.build().also { _buildingInsights1 = it }
    }
