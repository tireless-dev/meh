...
val BatteryHalf: ImageVector
    get() {
        val current = _batteryHalf
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.BatteryHalf",
            ...
            // <rect width="8" height="8" x="8.0" y="12.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 16 12
                ...
                // l -8 -3.496911E-7
                lineToRelative(dx = -8.0f, dy = -3.496911E-7f)
                // l 3.496911E-7 -8z
                lineToRelative(dx = 3.496911E-7f, dy = -8.0f)
                close()
            }
