...
val CalculatorCheck: ImageVector
    get() {
        val current = _calculatorCheck
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.CalculatorCheck",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <polygon points="24.0 26.59 21.41 24.0 20.0 25.41 24.0 29.41 31.0 22.41 29.59 21.0 24.0 26.59" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 24 26.59
                moveTo(x = 24.0f, y = 26.59f)
                // L 21.41 24
                lineTo(x = 21.41f, y = 24.0f)
                // L 20 25.41
                lineTo(x = 20.0f, y = 25.41f)
                // L 24 29.41
                lineTo(x = 24.0f, y = 29.41f)
                // L 31 22.41
                lineTo(x = 31.0f, y = 22.41f)
                // L 29.59 21
                lineTo(x = 29.59f, y = 21.0f)
                // L 24 26.59z
                lineTo(x = 24.0f, y = 26.59f)
                close()
            }
            ...
            // M17 30 H6 a2 2 0 0 1 -2 -2 V4 a2 2 0 0 1 2 -2 h20 a2 2 0 0 1 2 2 v14 h-2 V4 H6 v24 h11Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 17 30
        ...
        }.build().also { _calculatorCheck = it }
    }
