...
val ServiceId: ImageVector
    get() {
        val current = _serviceId
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.ServiceId",
            ...
            // <rect width="4" height="2" x="12.0" y="6.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 12 6
            ...
            // M6 28 V4 h16 v9 h2 V4 a2 2 0 0 0 -2 -2 H6 a2 2 0 0 0 -2 2 v24 a2 2 0 0 0 2 2 h8 v-2z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 6 28
        ...
        }.build().also { _serviceId = it }
    }

@Suppress("ObjectPropertyName")
private var _serviceId: ImageVector? = null
