...
val SecurityServices: ImageVector
    get() {
        val current = _securityServices
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.SecurityServices",
            ...
            // m14 26.67 -3.23 -1.73 A9 9 0 0 1 6 17 V4 h20 v10 h2 V4 a2 2 0 0 0 -2 -2 H6 a2 2 0 0 0 -2 2 v13 a11 11 0 0 0 5.82 9.7 L14 28.94Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 14 26.67
                moveTo(x = 14.0f, y = 26.67f)
                // l -3.23 -1.73
                lineToRelative(dx = -3.23f, dy = -1.73f)
                // A 9 9 0 0 1 6 17
                arcTo(
        ...
        }.build().also { _securityServices = it }
    }
