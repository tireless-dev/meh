...
val IntentRequestCreate: ImageVector
    get() {
        val current = _intentRequestCreate
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.IntentRequestCreate",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <polygon points="30.0 24.0 26.0 24.0 26.0 20.0 24.0 20.0 24.0 24.0 20.0 24.0 20.0 26.0 24.0 26.0 24.0 30.0 26.0 30.0 26.0 26.0 30.0 26.0" fill="#000" />
            path(
        ...
        }.build().also { _intentRequestCreate = it }
    }

@Suppress("ObjectPropertyName")
private var _intentRequestCreate: ImageVector? = null
