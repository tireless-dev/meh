...
val FeatureTyping: ImageVector
    get() {
        val current = _featureTyping
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.FeatureTyping",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <circle cx="17.5" cy="22.5" radius="1.5" fill="#000" stroke-width="0" />
            path(
                fill = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 0.0f,
            ) {
                // M 17.5 22.5
                moveTo(x = 17.5f, y = 22.5f)
                // m -1.5 0
            ...
            // <circle cx="6.5" cy="22.5" radius="1.5" fill="#000" stroke-width="0" />
            path(
                fill = SolidColor(Color(0xFF000000)),
                strokeLineWidth = 0.0f,
            ) {
                // M 6.5 22.5
                moveTo(x = 6.5f, y = 22.5f)
                // m -1.5 0
                moveToRelative(dx = -1.5f, dy = 0.0f)
                // a 1.5 1.5 0 1 1 3 0
                arcToRelative(
        ...
        }.build().also { _featureTyping = it }
    }

@Suppress("ObjectPropertyName")
private var _featureTyping: ImageVector? = null
