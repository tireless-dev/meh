...
val CloudServiceManagement: ImageVector
    get() {
        val current = _cloudServiceManagement
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.CloudServiceManagement",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M28 17 v5 H4 V6 h10 V4 H4 a2 2 0 0 0 -2 2 v16 a2 2 0 0 0 2 2 h8 v4 H8 v2 h16 v-2 h-4 v-4 h8 a2 2 0 0 0 2 -2 v-5Z M18 28 h-4 v-4 h4Z
            path(
        ...
        }.build().also { _cloudServiceManagement = it }
    }
