    ...
    get() {
        ...
        return ImageVector.Builder(
            ...
            path(
                ...
                // l 1.11 0.2
                lineToRelative(dx = 1.11f, dy = 0.2f)
                // c 2.43 0.44 3.57 1.52 3.57 3.5
                curveToRelative(
                    dx1 = 2.43f,
                    dy1 = 0.44f,
                    dx2 = 3.57f,
        ...
        }.build().also { _satisfyUsage = it }
    }

@Suppress("ObjectPropertyName")
private var _satisfyUsage: ImageVector? = null
