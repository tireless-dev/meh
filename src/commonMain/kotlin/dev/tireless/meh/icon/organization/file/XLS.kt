  ...
  get() {
    ...
    return ImageVector
      .Builder(
        ...
        // M28 23 h-6 v-2 h6 v-4 h-4 a2 2 0 0 1 -2 -2 v-4 a2 2 0 0 1 2 -2 h6 v2 h-6 v4 h4 a2 2 0 0 1 2 2 v4 a2 2 0 0 1 -2 2
        path(
        ...
        // <polygon points="10.0 9.0 8.0 9.0 6.0 15.0 4.0 9.0 2.0 9.0 4.752 16.0 2.0 23.0 4.0 23.0 6.0 17.0 8.0 23.0 10.0 23.0 7.245 16.0 10.0 9.0" fill="#000" />
        path(
          fill = SolidColor(Color(0xFF000000)),
        ) {
          // M 10 9
