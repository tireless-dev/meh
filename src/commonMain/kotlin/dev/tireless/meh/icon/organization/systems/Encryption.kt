...
val Encryption: ImageVector
    get() {
        val current = _encryption
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.Encryption",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M29 21.28 V19 a4 4 0 0 0 -8 0 v2.28 A2 2 0 0 0 20 23 v5 a2 2 0 0 0 2 2 h6 a2 2 0 0 0 2 -2 v-5 a2 2 0 0 0 -1 -1.72 M25 17 a2 2 0 0 1 2 2 v2 h-4 v-2 a2 2 0 0 1 2 -2 m-3 11 v-5 h6 v5Z
            path(
            ...
            // <rect width="2" height="8" x="14.0" y="18.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 14 18
            ...
            // M10 26 H8 a2 2 0 0 1 -2 -2 v-4 a2 2 0 0 1 2 -2 h2 a2 2 0 0 1 2 2 v4 a2 2 0 0 1 -2 2 m-2 -6 v4 h2 v-4Z m6 -4 h-2 a2 2 0 0 1 -2 -2 v-4 a2 2 0 0 1 2 -2 h2 a2 2 0 0 1 2 2 v4 a2 2 0 0 1 -2 2 m-2 -6 v4 h2 v-4Z m-2 -4 H8 a2 2 0 0 1 -2 -2 V2 h2 v2 h2 V2 h2 v2 a2 2 0 0 1 -2 2
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 10 26
