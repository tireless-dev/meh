...
val TextMiningApplier: ImageVector
    get() {
        val current = _textMiningApplier
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.TextMiningApplier",
            ...
            // <polygon points="20.0 19.0 27.0 24.0 20.0 29.0 20.0 19.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 20 19
        ...
        }.build().also { _textMiningApplier = it }
    }
