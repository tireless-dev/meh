  ...
  get() {
    ...
    return ImageVector
      .Builder(
        ...
        // <polygon points="7.0 11.0 10.0 11.0 10.0 21.0 7.0 21.0 7.0 23.0 15.0 23.0 15.0 21.0 12.0 21.0 12.0 11.0 15.0 11.0 15.0 9.0 7.0 9.0 7.0 11.0" fill="#000" stroke-width="0" />
        path(
          fill = SolidColor(Color(0xFF000000)),
          strokeLineWidth = 0.0f,
        ) {
