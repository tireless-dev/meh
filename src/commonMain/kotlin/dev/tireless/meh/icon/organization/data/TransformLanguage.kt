...
val TransformLanguage: ImageVector
    get() {
        val current = _transformLanguage
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.TransformLanguage",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <rect width="8" height="2" x="10.0" y="19.0" fill="#000" />
            path(
            ...
            // <rect width="12" height="2" x="10.0" y="11.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 10 11
        ...
        }.build().also { _transformLanguage = it }
    }

@Suppress("ObjectPropertyName")
private var _transformLanguage: ImageVector? = null
