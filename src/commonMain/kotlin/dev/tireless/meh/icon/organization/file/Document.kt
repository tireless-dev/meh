...
val Document: ImageVector
  get() {
    ...
    return ImageVector
      .Builder(
        name = "MehTheme.Document",
        defaultWidth = 32.0.dp,
        defaultHeight = 32.0.dp,
        viewportWidth = 32.0f,
        viewportHeight = 32.0f,
      ).apply {
        // m25.7 9.3 -7 -7 A1 1 0 0 0 18 2 H8 a2 2 0 0 0 -2 2 v24 a2 2 0 0 0 2 2 h16 a2 2 0 0 0 2 -2 V10 c0 -.3 -.1 -.5 -.3 -.7 M18 4.4 l5.6 5.6 H18z M24 28 H8 V4 h8 v6 a2 2 0 0 0 2 2 h6z
        path(
        ...
        // <rect width="12" height="2" x="10.0" y="22.0" fill="#000" />
        path(
          fill = SolidColor(Color(0xFF000000)),
        ) {
          // M 10 22
