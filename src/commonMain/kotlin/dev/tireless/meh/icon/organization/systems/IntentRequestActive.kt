...
val IntentRequestActive: ImageVector
    get() {
        val current = _intentRequestActive
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.IntentRequestActive",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <polygon points="23.0 27.2 20.4 24.6 19.0 26.0 23.0 30.0 31.0 22.0 29.6 20.6" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 23 27.2
                moveTo(x = 23.0f, y = 27.2f)
                // L 20.4 24.6
                lineTo(x = 20.4f, y = 24.6f)
                // L 19 26
                lineTo(x = 19.0f, y = 26.0f)
                // L 23 30
                lineTo(x = 23.0f, y = 30.0f)
                // L 31 22
                lineTo(x = 31.0f, y = 22.0f)
                // L 29.6 20.6z
                lineTo(x = 29.6f, y = 20.6f)
                close()
            }
        ...
        }.build().also { _intentRequestActive = it }
    }

@Suppress("ObjectPropertyName")
private var _intentRequestActive: ImageVector? = null
