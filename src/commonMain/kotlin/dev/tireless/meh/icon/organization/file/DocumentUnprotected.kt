...
val DocumentUnprotected: ImageVector
    get() {
        val current = _documentUnprotected
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.DocumentUnprotected",
            ...
            // M28 21 h-6 v-3 a2 2 0 0 1 4 0 h2 a4 4 0 0 0 -8 0 v3 a2 2 0 0 0 -2 2 v5 a2 2 0 0 0 2 2 h8 a2 2 0 0 0 2 -2 v-5 a2 2 0 0 0 -2 -2 m-8 7 v-5 h8 v5Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 28 21
        ...
        }.build().also { _documentUnprotected = it }
    }
