  ...
  get() {
    ...
    return ImageVector
      .Builder(
        ...
        // M30 15 v-4 a2 2 0 0 0 -2 -2 h-6 v14 h2 v-6 h1.48 l2.34 6 H30 l-2.33 -6 H28 a2 2 0 0 0 2 -2 m-6 -4 h4 v4 h-4Z
        path(
        ...
        // M6 23 H2 V9 h4 a4 4 0 0 1 4 4 v6 a4 4 0 0 1 -4 4 m-2 -2 h2 a2 2 0 0 0 2 -2 v-6 a2 2 0 0 0 -2 -2 H4Z
        path(
          fill = SolidColor(Color(0xFF000000)),
        ) {
          // M 6 23
