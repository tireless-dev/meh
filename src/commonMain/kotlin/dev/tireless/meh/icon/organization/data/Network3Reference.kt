...
val Network3Reference: ImageVector
    get() {
        val current = _network3Reference
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.Network3Reference",
            ...
            // M30 30 h-8 v-8 h8Z m-6 -2 h4 v-4 h-4Z m-4 -8 h-8 v-8 h8Z m-6 -2 h4 v-4 h-4Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 30 30
        ...
        }.build().also { _network3Reference = it }
    }
