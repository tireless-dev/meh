...
val BareMetalServer: ImageVector
    get() {
        val current = _bareMetalServer
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.BareMetalServer",
            ...
            // <circle cx="9.0" cy="26.0" radius="1.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 9 26
            ...
            // M26 30 H6 a2 2 0 0 1 -2 -2 v-4 a2 2 0 0 1 2 -2 h20 a2 2 0 0 1 2 2 v4 a2 2 0 0 1 -2 2 M6 24 v4 h20 v-4Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 26 30
        ...
        }.build().also { _bareMetalServer = it }
    }
