...
val ChartComboStacked: ImageVector
    get() {
        val current = _chartComboStacked
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.ChartComboStacked",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M27 28 V16 h-8 v12 h-4 V12 H7 v16 H4 V2 H2 v26 a2 2 0 0 0 2 2 h26 v-2Z M13 14 v6 H9 v-6Z m12 4 v6 h-4 v-6Z
            path(
        ...
        }.build().also { _chartComboStacked = it }
    }
