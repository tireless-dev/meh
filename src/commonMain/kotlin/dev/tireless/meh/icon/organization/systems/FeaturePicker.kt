...
val FeaturePicker: ImageVector
    get() {
        ...
        }.build().also { _featurePicker = it }
    }

@Suppress("ObjectPropertyName")
private var _featurePicker: ImageVector? = null
