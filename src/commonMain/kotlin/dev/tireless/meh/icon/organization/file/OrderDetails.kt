...
val OrderDetails: ImageVector
    get() {
        val current = _orderDetails
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.OrderDetails",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M19 21 h-6 a3 3 0 0 0 -3 3 v2 h2 v-2 a1 1 0 0 1 1 -1 h6 a1 1 0 0 1 1 1 v2 h2 v-2 a3 3 0 0 0 -3 -3 m-3 -1 a4 4 0 1 0 -4 -4 4 4 0 0 0 4 4 m0 -6 a2 2 0 1 1 -2 2 2 2 0 0 1 2 -2
            path(
