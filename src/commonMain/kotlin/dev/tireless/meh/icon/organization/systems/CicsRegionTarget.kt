...
val CicsRegionTarget: ImageVector
    get() {
        val current = _cicsRegionTarget
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.CicsRegionTarget",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <rect width="2" height="3" x="26.0" y="7.0" fill="#000" />
            path(
            ...
            // <rect width="3" height="2" x="29.0" y="4.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 29 4
            ...
            // <rect width="2" height="3" x="26.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 26 0
            ...
            // <rect width="3" height="2" x="22.0" y="4.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 22 4
        ...
        }.build().also { _cicsRegionTarget = it }
    }
