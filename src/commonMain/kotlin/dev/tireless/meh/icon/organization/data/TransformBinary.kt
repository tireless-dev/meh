...
val TransformBinary: ImageVector
    get() {
        val current = _transformBinary
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.TransformBinary",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M23 20 h-2 a2 2 0 0 1 -2 -2 v-4 a2 2 0 0 1 2 -2 h2 a2 2 0 0 1 2 2 v4 a2 2 0 0 1 -2 2 m-2 -6 v4 h2 v-4z
            path(
            ...
            // <rect width="2" height="8" x="15.0" y="12.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 15 12
        ...
        }.build().also { _transformBinary = it }
    }

@Suppress("ObjectPropertyName")
private var _transformBinary: ImageVector? = null
