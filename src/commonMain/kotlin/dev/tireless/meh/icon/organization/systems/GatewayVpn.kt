...
val GatewayVpn: ImageVector
    get() {
        val current = _gatewayVpn
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.GatewayVpn",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M20 14.28 V12 a4 4 0 0 0 -8 0 v2.28 A2 2 0 0 0 11 16 v5 a2 2 0 0 0 2 2 h6 a2 2 0 0 0 2 -2 v-5 a2 2 0 0 0 -1 -1.72 M16 10 a2 2 0 0 1 2 2 v2 h-4 v-2 a2 2 0 0 1 2 -2 m3 11 h-6 v-5 h6Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 20 14.28
                moveTo(x = 20.0f, y = 14.28f)
                // V 12
