...
val ChartTSne: ImageVector
    get() {
        val current = _chartTSne
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.ChartTSne",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <circle cx="10.0" cy="20.0" radius="2.0" fill="#000" />
            path(
            ...
            // <circle cx="22.0" cy="6.0" radius="2.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 22 6
            ...
            // <circle cx="20.0" cy="12.0" radius="2.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 20 12
            ...
            // <circle cx="28.0" cy="22.0" radius="2.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 28 22
            ...
            // <circle cx="26.0" cy="28.0" radius="2.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 26 28
            ...
            // <circle cx="20.0" cy="26.0" radius="2.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 20 26
            ...
            // <circle cx="22.0" cy="20.0" radius="2.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 22 20
            ...
            // <circle cx="4.0" cy="24.0" radius="2.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 4 24
