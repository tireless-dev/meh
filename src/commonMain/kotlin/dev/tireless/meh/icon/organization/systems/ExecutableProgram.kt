...
val ExecutableProgram: ImageVector
    get() {
        val current = _executableProgram
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.ExecutableProgram",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <polygon points="25.0 21.0 32.0 26.0 25.0 31.0 25.0 21.0" fill="#000" style="fill-rule:evenodd" fill-rule="evenodd" />
            path(
            ...
            // M21 26 H4 V12 h24 v7 h2 V6 a2 2 0 0 0 -2 -2 H4 a2 2 0 0 0 -2 2 v20 a2 2 0 0 0 2 2 h17z M4 6 h24 v4 H4z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 21 26
        ...
        }.build().also { _executableProgram = it }
    }

@Suppress("ObjectPropertyName")
private var _executableProgram: ImageVector? = null
