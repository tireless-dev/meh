...
val ChevronRight: ImageVector
    get() {
        ...
        return ImageVector.Builder(
            name = "MehTheme.ChevronRight",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <polygon points="22.0 16.0 12.0 26.0 10.6 24.6 19.2 16.0 10.6 7.4 12.0 6.0" fill="#000" />
            path(
                ...
                // L 10.6 24.6
                lineTo(x = 10.6f, y = 24.6f)
                // L 19.2 16
                lineTo(x = 19.2f, y = 16.0f)
                // L 10.6 7.4
