...
val AsleepFilled: ImageVector
    get() {
        val current = _asleepFilled
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.AsleepFilled",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // m14.98 3 -.17 .02 A13.1 13.1 0 0 0 16.63 29 h.5 a13 13 0 0 0 10.7 -5.56 1 1 0 0 0 -.79 -1.56 13.08 13.08 0 0 1 -11.15 -17.5 A1 1 0 0 0 14.98 3
            path(
        ...
        }.build().also { _asleepFilled = it }
    }

@Suppress("ObjectPropertyName")
private var _asleepFilled: ImageVector? = null
