...
val StopOutline: ImageVector
    get() {
        val current = _stopOutline
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.StopOutline",
            ...
            // M20 12 v8 h-8 v-8z m0 -2 h-8 a2 2 0 0 0 -2 2 v8 a2 2 0 0 0 2 2 h8 a2 2 0 0 0 2 -2 v-8 a2 2 0 0 0 -2 -2
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 20 12
