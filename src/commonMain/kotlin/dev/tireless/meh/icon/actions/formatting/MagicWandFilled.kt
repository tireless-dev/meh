...
val MagicWandFilled: ImageVector
    get() {
        val current = _magicWandFilled
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.MagicWandFilled",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M29.41 24 12 6.59 a2.05 2.05 0 0 0 -2.83 0 L6.6 9.17 a2 2 0 0 0 0 2.83 l17.4 17.41 a2 2 0 0 0 2.84 0 l2.58 -2.58 a2 2 0 0 0 0 -2.83 M8 10.59 10.59 8 l5 5 -2.6 2.59z
            path(
        ...
        }.build().also { _magicWandFilled = it }
    }

@Suppress("ObjectPropertyName")
private var _magicWandFilled: ImageVector? = null
