...
val OperationsField: ImageVector
    get() {
        val current = _operationsField
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.OperationsField",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <rect width="10" height="2" x="16.0" y="6.0" fill="#000" />
            path(
            ...
            // <rect width="10" height="2" x="24.0" y="6.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 28 12
            ...
            // M16 20 a3.9 3.9 0 0 1 -4 -4 3.9 3.9 0 0 1 4 -4 v-2 a6 6 0 1 0 6 6 h-2 a3.9 3.9 0 0 1 -4 4
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 16 20
            ...
            // M28.9 18.45 26.1 16 l-1.32 1.5 2.8 2.46 -2.37 4.08 -3.43 -1.16 a9 9 0 0 1 -2.7 1.57 L18.35 28 h-4.72 l-.71 -3.55 a9 9 0 0 1 -2.7 -1.57 L6.8 24.04 l-2.36 -4.08 2.72 -2.4 a9 9 0 0 1 0 -3.13 l-2.72 -2.39 2.36 -4.08 3.43 1.16 a9 9 0 0 1 2.7 -1.57 L13.65 4 H16 V2 h-2.36 a2 2 0 0 0 -1.96 1.6 l-.5 2.53 a11 11 0 0 0 -1.33 .75 L7.43 6.06 a2 2 0 0 0 -2.37 .9 L2.7 11.04 a2 2 0 0 0 .4 2.5 l1.94 1.7 Q5 15.61 5 16 l.03 .77 -1.92 1.68 a2 2 0 0 0 -.41 2.5 l2.36 4.1 a2 2 0 0 0 2.37 .89 l2.43 -.82 a11 11 0 0 0 1.31 .75 l.5 2.52 A2 2 0 0 0 13.65 30 h4.72 a2 2 0 0 0 1.96 -1.6 l.5 -2.53 a11 11 0 0 0 1.33 -.75 l2.42 .82 a2 2 0 0 0 2.37 -.9 l2.36 -4.08 a2 2 0 0 0 -.4 -2.5
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 28.9 18.45
                moveTo(x = 28.9f, y = 18.45f)
                // L 26.1 16
                ...
                // l -2.37 4.08
                lineToRelative(dx = -2.37f, dy = 4.08f)
                // l -3.43 -1.16
        ...
        }.build().also { _operationsField = it }
    }
