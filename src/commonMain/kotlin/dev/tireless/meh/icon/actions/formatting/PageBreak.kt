...
val PageBreak: ImageVector
    get() {
        val current = _pageBreak
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.PageBreak",
            ...
            // M24 22 v6 H8 v-6 H6 v6 a2 2 0 0 0 2 2 h16 a2 2 0 0 0 2 -2 v-6Z M8 16 V4 h8 v6 a2 2 0 0 0 2 2 h6 v4 h2 v-6 a1 1 0 0 0 -.3 -.7 l-7 -7 A1 1 0 0 0 18 2 H8 a2 2 0 0 0 -2 2 v12Z M18 4.4 l5.6 5.6 H18Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 24 22
