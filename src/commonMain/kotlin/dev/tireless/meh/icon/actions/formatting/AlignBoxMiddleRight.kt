...
val AlignBoxMiddleRight: ImageVector
    get() {
        val current = _alignBoxMiddleRight
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.AlignBoxMiddleRight",
            ...
            // <rect width="11" height="2" x="12.0" y="13.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 23 15
            ...
            // <rect width="7" height="2" x="16.0" y="18.0" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 23 20
        ...
        }.build().also { _alignBoxMiddleRight = it }
    }
