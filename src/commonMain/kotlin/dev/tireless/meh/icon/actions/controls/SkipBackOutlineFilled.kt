...
val SkipBackOutlineFilled: ImageVector
    get() {
        val current = _skipBackOutlineFilled
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.SkipBackOutlineFilled",
            ...
            // <polygon points="22.0 19.301 22.0 12.699 16.059 16.0 22.0 19.301" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 22 19.301
                moveTo(x = 22.0f, y = 19.301f)
                // L 22 12.699
                lineTo(x = 22.0f, y = 12.699f)
                // L 16.059 16
                lineTo(x = 16.059f, y = 16.0f)
                // L 22 19.301z
                lineTo(x = 22.0f, y = 19.301f)
                close()
            }
        ...
        }.build().also { _skipBackOutlineFilled = it }
    }

@Suppress("ObjectPropertyName")
private var _skipBackOutlineFilled: ImageVector? = null
