...
val Notification: ImageVector
  get() {
    ...
    return ImageVector
      .Builder(
        name = "MehTheme.Notification",
        defaultWidth = 32.0.dp,
        defaultHeight = 32.0.dp,
        viewportWidth = 32.0f,
        viewportHeight = 32.0f,
      ).apply {
        // M28.7 19.3 26 16.58 V13 a10 10 0 0 0 -9 -9.95 V1 h-2 v2.05 A10 10 0 0 0 6 13 v3.59 l-2.7 2.7 A1 1 0 0 0 3 20 v3 a1 1 0 0 0 1 1 h7 v.78 a5.15 5.15 0 0 0 4.5 5.2 A5 5 0 0 0 21 25 v-1 h7 a1 1 0 0 0 1 -1 v-3 a1 1 0 0 0 -.3 -.7 M19 25 a3 3 0 0 1 -6 0 v-1 h6Z m8 -3 H5 v-1.59 l2.7 -2.7 A1 1 0 0 0 8 17 v-4 a8 8 0 0 1 16 0 v4 a1 1 0 0 0 .3 .7 l2.7 2.71Z
        path(
