...
val ShrinkScreenFilled: ImageVector
    get() {
        val current = _shrinkScreenFilled
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.ShrinkScreenFilled",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <rect width="15" height="10" rx="2.0" x="15.0" y="18.0" fill="#000" />
            path(
        ...
        }.build().also { _shrinkScreenFilled = it }
    }

@Suppress("ObjectPropertyName")
private var _shrinkScreenFilled: ImageVector? = null
