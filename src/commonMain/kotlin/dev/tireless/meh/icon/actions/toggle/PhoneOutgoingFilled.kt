...
val PhoneOutgoingFilled: ImageVector
    get() {
        val current = _phoneOutgoingFilled
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.PhoneOutgoingFilled",
            ...
            // <polygon points="20.0 4.0 20.0 6.0 24.586 6.0 18.0 12.586 19.414 14.0 26.0 7.414 26.0 12.0 28.0 12.0 28.0 4.0 20.0 4.0" fill="#000" style="fill:#231f20" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 20 4
        ...
        }.build().also { _phoneOutgoingFilled = it }
    }

@Suppress("ObjectPropertyName")
private var _phoneOutgoingFilled: ImageVector? = null
