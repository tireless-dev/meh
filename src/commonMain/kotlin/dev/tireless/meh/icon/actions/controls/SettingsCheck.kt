...
val SettingsCheck: ImageVector
    get() {
        val current = _settingsCheck
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.SettingsCheck",
            ...
            // <polygon points="23.0 26.18 20.41 23.59 19.0 25.0 23.0 29.0 30.0 22.0 28.59 20.59 23.0 26.18" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 23 26.18
                moveTo(x = 23.0f, y = 26.18f)
                // L 20.41 23.59
                lineTo(x = 20.41f, y = 23.59f)
                // L 19 25
