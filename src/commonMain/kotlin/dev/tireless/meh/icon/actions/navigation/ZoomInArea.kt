...
val ZoomInArea: ImageVector
    get() {
        val current = _zoomInArea
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.ZoomInArea",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <polygon points="24.0 19.0 21.0 19.0 21.0 16.0 19.0 16.0 19.0 19.0 16.0 19.0 16.0 21.0 19.0 21.0 19.0 24.0 21.0 24.0 21.0 21.0 24.0 21.0 24.0 19.0" fill="#000" />
            path(
            ...
            // m31 29.59 -4.69 -4.7 a8.03 8.03 0 1 0 -1.41 1.42 L29.59 31Z M20 26 a6 6 0 1 1 6 -6 6 6 0 0 1 -6 6 M4 8 H2 V4 a2 2 0 0 1 2 -2 h4 v2 H4Z m22 0 h-2 V4 h-4 V2 h4 a2 2 0 0 1 2 2Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 31 29.59
                moveTo(x = 31.0f, y = 29.59f)
                // l -4.69 -4.7
