...
val TrophyFilled: ImageVector
    get() {
        val current = _trophyFilled
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.TrophyFilled",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // M26 7 h-2 V6 a2 2 0 0 0 -2 -2 H10 a2 2 0 0 0 -2 2 v1 H6 a2 2 0 0 0 -2 2 v3 a4 4 0 0 0 4 4 h.32 A8.2 8.2 0 0 0 15 21.93 V26 h-5 v2 h12 v-2 h-5 v-4.07 A8 8 0 0 0 23.74 16 H24 a4 4 0 0 0 4 -4 V9 a2 2 0 0 0 -2 -2 M8 14 a2 2 0 0 1 -2 -2 V9 h2Z m18 -2 a2 2 0 0 1 -2 2 V9 h2Z
            path(
