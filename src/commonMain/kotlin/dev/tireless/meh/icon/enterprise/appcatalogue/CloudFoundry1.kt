...
val CloudFoundry1: ImageVector
    get() {
        val current = _cloudFoundry1
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.CloudFoundry1",
            ...
            // M14 24 h-3 a2 2 0 0 1 -2 -2 v-3 a2 2 0 0 1 2 -2 h3 v2 h-3 v3 h3Z m7 -9 v-2 h-2 a2 2 0 0 0 -2 2 v2 h-1 v2 h1 v5 h2 v-5 h2 v-2 h-2 v-2Z
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 14 24
