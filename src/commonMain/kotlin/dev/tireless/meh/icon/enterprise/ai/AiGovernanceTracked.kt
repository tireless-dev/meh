...
val AiGovernanceTracked: ImageVector
    get() {
        val current = _aiGovernanceTracked
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.AiGovernanceTracked",
            defaultWidth = 32.0.dp,
            defaultHeight = 32.0.dp,
            viewportWidth = 32.0f,
            viewportHeight = 32.0f,
        ).apply {
            // <polygon points="23.0 27.5898 20.41 24.9999 19.0 26.41 23.0 30.41 31.0 22.41 29.5899 21.0 23.0 27.5898" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 23 27.5898
                moveTo(x = 23.0f, y = 27.5898f)
                // L 20.41 24.9999
                lineTo(x = 20.41f, y = 24.9999f)
                // L 19 26.41
                lineTo(x = 19.0f, y = 26.41f)
                // L 23 30.41
                lineTo(x = 23.0f, y = 30.41f)
                // L 31 22.41
                lineTo(x = 31.0f, y = 22.41f)
                // L 29.5899 21
                lineTo(x = 29.5899f, y = 21.0f)
                // L 23 27.5898z
                lineTo(x = 23.0f, y = 27.5898f)
                close()
            }
        ...
        }.build().also { _aiGovernanceTracked = it }
    }

@Suppress("ObjectPropertyName")
private var _aiGovernanceTracked: ImageVector? = null
