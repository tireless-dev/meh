...
val ShoppingCartArrowUp: ImageVector
    get() {
        val current = _shoppingCartArrowUp
        if (current != null) return current

        return ImageVector.Builder(
            name = "MehTheme.ShoppingCartArrowUp",
            ...
            // <polygon points="21.586 9.414 18.0 5.828 18.0 14.0 16.0 14.0 16.0 5.828 12.414 9.414 11.0 8.0 17.0 2.0 23.0 8.0 21.586 9.414" fill="#000" />
            path(
                fill = SolidColor(Color(0xFF000000)),
            ) {
                // M 21.586 9.414
                moveTo(x = 21.586f, y = 9.414f)
                // L 18 5.828
                lineTo(x = 18.0f, y = 5.828f)
                // L 18 14
                lineTo(x = 18.0f, y = 14.0f)
                // L 16 14
                lineTo(x = 16.0f, y = 14.0f)
                // L 16 5.828
                lineTo(x = 16.0f, y = 5.828f)
                // L 12.414 9.414
                lineTo(x = 12.414f, y = 9.414f)
                // L 11 8
        ...
        }.build().also { _shoppingCartArrowUp = it }
    }
