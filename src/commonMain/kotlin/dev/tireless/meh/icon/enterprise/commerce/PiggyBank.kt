...
val PiggyBank: ImageVector
  get() {
    ...
    return ImageVector
      .Builder(
        name = "MehTheme.PiggyBank",
        defaultWidth = 32.0.dp,
        defaultHeight = 32.0.dp,
        viewportWidth = 32.0f,
        viewportHeight = 32.0f,
      ).apply {
        // M16.5 14 H20 v-2 h-2 v-1 h-2 v1.05 A2.5 2.5 0 0 0 16.5 17 h1 a.5 .5 0 0 1 0 1 H14 v2 h2 v1 h2 v-1.05 A2.5 2.5 0 0 0 17.5 15 h-1 a.5 .5 0 0 1 0 -1
        path(
          fill = SolidColor(Color(0xFF000000)),
        ) {
          // M 16.5 14
          moveTo(x = 16.5f, y = 14.0f)
          // H 20
